...
@section('title', 'Dashboard Manajemen Create Organitation')
@prepend('css')
...
<div class="row">
        <div class="card-body">
            <div class="border p-4 rounded">
                ...
                <hr/>
                <form action="{{route('admin.organitation.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control @error('position') is-invalid @enderror" value="{{old('position')}}" required  placeholder="Enter Your Position" id="position" name="position"></input>
                        @error('position')
                        <div class="invalid-feedback mt-1">
                            {{ $message }}
                        </div>
